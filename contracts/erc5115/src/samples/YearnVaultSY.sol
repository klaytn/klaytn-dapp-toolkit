...
import "../abstracts/SYBase.sol";
import "../interfaces/IYearnVault.sol";

contract YearnVaultSY is SYBase {
    address public immutable underlying;
    address public immutable yvToken;

    uint256 public override exchangeRateStored;

    constructor(string memory _name, string memory _symbol, address _underlying, address _yvToken)
        SYBase(_name, _symbol, _yvToken)
    {
