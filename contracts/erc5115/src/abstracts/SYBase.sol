...
abstract contract SYBase is IStandardizedYield, ERC20, ReentrancyGuard, TokenHelper {
    ...
    constructor(string memory _name, string memory _symbol, address _yieldToken) ERC20(_name, _symbol) {
     ...
     */
    function deposit(address receiver, address tokenIn, uint256 amountTokenToPull, uint256 minSharesOut)
        external
        payable
        nonReentrant
        updateReserve
    ...
    /**
     * @dev See {IStandardizedYield-exchangeRateCurrent}
     */
    function exchangeRateCurrent() external virtual override returns (uint256 res);

    /**
     * @dev See {IStandardizedYield-exchangeRateStored}
     */
    ...
    /**
     * @dev See {IStandardizedYield-accruredRewards}
     */
    ...
    /**
     * @notice See {IStandardizedYield-decimals}
     */
    ...
    /**
     * @notice See {IStandardizedYield-getBaseTokens}
     */
    function getBaseTokens() external view virtual override returns (address[] memory res);

    /**
     * @dev See {IStandardizedYield-isValidBaseToken}
     */
