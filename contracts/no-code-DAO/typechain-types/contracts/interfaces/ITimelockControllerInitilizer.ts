...
export interface ITimelockControllerInitilizerInterface
...
export interface ITimelockControllerInitilizer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ITimelockControllerInitilizerInterface;
