...
export interface StandardGovernorInterface extends utils.Interface {
  functions: {
    ...
    "initialize(address,address,uint256,uint256,uint256,uint256,string)": FunctionFragment;
...
export interface StandardGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StandardGovernorInterface;
